...
import type { AuthMode } from "@/components/platform/auth-mode";

export type { AuthMode } from "@/components/platform/auth-mode";
export { parseAuthMode } from "@/components/platform/auth-mode";
