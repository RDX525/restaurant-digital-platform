...
export function analyticsReportToCsv(report: AnalyticsReport): string {
  const rows: string[][] = [
    ...
    ["Reservations", String(report.reservations)],
    ["Reservation cancellations", String(report.reservationCancellations)],
    ["Reservation no-shows", String(report.reservationNoShows)],
